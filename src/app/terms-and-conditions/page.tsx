        ...
        <>
          ...
          <Container>
            <Row>
              ...
              <Col md={4} className="relative max-[786px]:pb-[20px]">
                <div
              ...
              {/* Content Section */}
              <Col md={8} ref={contentRef}>
                <ReactMarkdown rehypePlugins={[rehypeRaw]} className="privacy-terms-conditions-cookies-data pt-[24px]">
                  {detail}
                </ReactMarkdown>
              </Col>
            </Row>
