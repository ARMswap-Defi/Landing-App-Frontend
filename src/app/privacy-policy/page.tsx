    ...
    GlobalApi.GetPrivacyPolicy()
      .then((resp) => {
        ...
        if (!attributes) {
          ...
          setMetatag(resp?.data?.data?.meta_tag);
          setDetail(resp?.data?.data?.content);
        }
        setLoading(false);
      })
      .catch(() => {
        ...
        <>
          ...
          <Container>
            <Row className="relative">
              ...
              <Col
                md={4}
                className="sticky top-10 max-h-[calc(100vh-100px)] overflow-y-auto"
              >
                <div
              ...
              {/* Content Section */}
              <Col md={8} ref={contentRef} className="privacy-terms-conditions-cookies-data pt-[24px]">
